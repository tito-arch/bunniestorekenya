...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <a href="#about" onClick={() => setActiveNav('#about')} className={activeNav === '#about' ? 'active' : ''}><ShopTwoTone /></a>
      <a href="#portifolio" onClick={() => setActiveNav('#portifolio')} className={activeNav === '#portifolio' ? 'active' : ''}><BookOutlined /></a>
